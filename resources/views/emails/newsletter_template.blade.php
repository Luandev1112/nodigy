...
<div style="background:url({{asset('/')}}email-img/emailbg.jpg) center no-repeat; background-size:cover; display:flex; max-width:640px; margin:0 auto;">
    ...
    <div style="width:calc(100% - 100px);">
        ...
        <p style="font-family:arial; font-size: 18px; line-height: 24px; color:#E8EDFF; margin-bottom:30px;">Click the big confirm button to subscribe to {{$userData['appName']}}. If you don’t confirm, you won’t receive our newsletter.</p>
        ...
        <p style="font-family:arial; font-size: 18px; line-height: 24px; color:#E8EDFF; margin-bottom:30px;">Makes sure you add this email address (noreplay@nodigy.com) to your address book. This way you won’t miss a single newsletter.</p>
