...
const NodeFooter = ({step, prevStep, nextStep, disableBtn}) => {
    const gotoPage = () => {
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        ...
                        {
                            <a onClick={()=>prevStep()} className={disableBtn=='prev'?"btn btn-primary":"btn btn-primary active"}>Previous</a>
                        }
                            <span>Step {step} of 8</span>
                        {
                            <a onClick={()=>nextStep()} className={disableBtn=='next'?"btn btn-primary":"btn btn-primary active"}>Next</a>
                        }
                        </div>
                    </div>
                    <div className="col-sm-3">
