											...
											<div className="innerbox transparentbg">
												...
												{!wallet.wallet_address ?
													...
													<div className="hovercontent">
														...
														{wallet.wallet_address && <p><span>{shortenAddress(wallet.wallet_address)}</span><span><a href="#"><img src="/img/icon-copy.svg" /></a></span></p>}
													</div>
												}
											</div>
										</div>		
										...
										<div className={chooseClass(wallet, i)} onClick={() => chooseWallet(i)}>
											<div className="innerbox transparentbg">
												...
												<div className="hovercontent">
													...
													<p><span>{wallet.wallet_address}</span><span><a href="#"><img src="/img/icon-copy.svg" /></a></span></p>
												</div>
											</div>
										</div>
									}
