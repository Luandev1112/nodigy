...
const Step1 = ({stepType, changeStepType}) => {
    
    const chooseExperience = (content) => {
        changeStepType(content);
    }
    useEffect(()=> {
    }, []);
    return (
                ...
                <div className="borerbox">
                    <div className="row">
                        <div className="col-sm-6">
                            <div className={stepType=='experience'?"border-up innerbox selected":"border-up innerbox"} role='button' onClick={()=>chooseExperience('experience')}>
                        ...
                        <div className="col-sm-6">
                            <div className={stepType=='no-experience'?"innerbox transparentbg selected":"innerbox transparentbg"} role='button' onClick={()=>chooseExperience('no-experience')}>
