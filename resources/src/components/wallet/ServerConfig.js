                                    ...
                                    <table className="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span><img src="/img/icon-vspus.svg" /> 1 Intel</span></td>
                                                <td className="graytext">2 GB</td>
                                                <td><span><img src="/img/icon-storage.svg" /> 16 GB</span></td>
                                            </tr>
                                            <tr>
                                                <td className="graytext">2</td>
                                                <td>Recommended</td>
                                                <td><span><img src="/img/icon-vspus-black.svg" /> 2 Intel</span></td>
                                                <td className="graytext">4 GB</td>
                                                <td><span><img src="/img/icon-storage-black.svg" /> 32 GB</span></td>
                                            </tr>
                                            <tr>
                                                <td className="graytext">3</td>
                                                <td>Max performance</td>
                                                <td><span><img src="/img/icon-vspus.svg" /> 4 Intel</span></td>
                                                <td className="graytext">8 GB</td>
                                                <td><span><img src="/img/icon-storage.svg" /> 64 GB</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
